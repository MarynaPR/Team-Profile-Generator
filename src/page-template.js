...
const generateTeam = employeeData => {
  ...
  <div class="col-12 mb-2 bg-dark text-light p-3">
  <div>Name: ${name}</div>
  <p class="card-header background"><span class="name"><i class="fas fa-mug-hot"></i>Role: Engineer</span></p>
  <div class="item-title text-light">Email: ${email}</div>
  <div>
   <p>ID: ${id}</p>
  </div>
   ...
   <div class="col-12 mb-2 bg-dark text-light p-3">
   <div>Name: ${name}</div>
   <p class="card-header background"><span class="name"><i class="fas fa-mug-hot"></i>Role: Intern</span></p>
   <div class="item-title text-light">Email: ${email}</div>
   <div>
     <p>ID: ${id}</p>
   </div>
     <p class="btn mt-auto"><i class="fab fa-school mr-2"></i>School: ${school}</p>
  </div>
   `;
      })
    }
...
module.exports = templateData => {
 ...
 <html lang="en">
  ...
  <link rel="stylesheet" href="style.css">
   ...
   <div class="container">
   <div class="row">
   <div class="team-area col-12 d-flex justify-content-center">${generateTeam(templateData)}
   </div>
   </div>
   </div>
   </body>
